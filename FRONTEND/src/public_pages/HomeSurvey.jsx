...
function HomeSurvey({ phoneNumber, setPhoneNumber, description, setDescription, district, setDistrict, address, setAddress, selectedDate, setSelectedDate, timePeriod, setTimePeriod, periods, districts }) {
    return (
        <>
