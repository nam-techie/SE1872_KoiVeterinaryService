...
import ManageDoctorWork from "./ManageDoctorWork.jsx";
    ...
    switch (activeTab) {
      ...
      case "doctors":
        if (isAddingDoctor) {
          return (
            <AddDoctor
              onClose={handleAddDoctorClose}
              onAdd={handleDoctorAdded}
            />
          );
    ...
    <div className="admin-dashboard">
      <div className="sidebar">
        ...
        <ul className="sidebar-menu">
          ...
          <li
            className={`menu-item ${activeTab === "fish" ? "active" : ""}`}
          ...
          <li
            className={`menu-item ${activeTab === "doctorWork" ? "active" : ""}`}
            onClick={() => setActiveTab("doctorWork")}
          >
            <FaBriefcaseMedical /> Quản lý lịch làm việc
          </li>
          <li
