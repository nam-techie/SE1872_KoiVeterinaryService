...
import CustomerAppointmentModal from "./CustomerAppointmentModal.jsx";
...
const CustomerAppointmentPage = () => {
    ...
    // hàm chuyển đổi 1 string sang 1 Date
    ...
    // sau khi sortData thì sẽ filter theo thứ minh cần
    ...
    return (
        <>
            ...
            {/* ================== TABLE ================ */}
            <div
                className="p-4 shadow-md overflow-x-auto"
            ...
            {/* ================= MODAL ================ */}
            {/* Được show ra khi click vào chi tiết */}
            {selectedAppointment && (
